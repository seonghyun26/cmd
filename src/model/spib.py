...
class SPIB(nn.Module):
    ...
    def save_representative_parameters(self, path, index=0):
        ...
        representative_path = path + '/representative_inputs' + str(index) + '.npy'
        representative_weight_path = path + '/representative_weight' + str(index) + '.npy'
        representative_z_mean_path = path + '/representative_z_mean' + str(index) + '.npy'
        representative_z_logvar_path = path + '/representative_z_logvar' + str(index) + '.npy'
    ...
    def save_traj_results(self, inputs, batch_size, path, SaveTrajResults, traj_index=0, index=1):
        ...
        population_path = path + '/traj%d_state_population'%(traj_index) + str(index) + '.npy'
        ...
        if self.encoder_type == 'Linear': 
            z_mean_encoder_weight_path = path + '/z_mean_encoder_weight' + str(index) + '.npy'
            z_mean_encoder_bias_path = path + '/z_mean_encoder_bias' + str(index) + '.npy'
        ...
        if SaveTrajResults:
            ...
            label_path = path + '/traj%d_labels'%(traj_index) + str(index) + '.npy'
            os.makedirs(os.path.dirname(label_path), exist_ok=True)
            
            np.save(label_path, labels.cpu().data.numpy())
            
            prediction_path = path + '/traj%d_data_prediction'%(traj_index) + str(index) + '.npy'
            representation_path = path + '/traj%d_representation'%(traj_index) + str(index) + '.npy'
            mean_representation_path = path + '/traj%d_mean_representation'%(traj_index) + str(index) + '.npy'
